...
//		try {
//			register = new Register("ab000006","gokul6","km6","gokul6@gmail.com","uvwx1234",null);
//			register.setContactnumber(new BigDecimal("6789012345"));
//			
...
////		try {
////			service = UserServiceImpl.getInstance();
////			service.deleteUserById("ab000006");
...
////			System.out.println(service2.changeRole("gokul6@gmail.com", ROLE.ROLE_ADMIN));
////		} catch (IOException e) {
////			// TODO Auto-generated catch block
////			e.printStackTrace();
////		}
