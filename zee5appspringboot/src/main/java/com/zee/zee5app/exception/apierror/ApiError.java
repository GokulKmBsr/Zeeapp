...
//public class ApiError {
//	
//	//should provide the collective info regarding errors/error
//	private HttpStatus httpStatus;
//	@JsonFormat(shape=JsonFormat.Shape.STRING,pattern="dd-MM-yyyy hh:mm:ss")
//	private LocalDateTime timeStamp;
//	private String message;
//	private String debugMessage;
//	private List<ApiSubError> subErrors;//to hold validational relayed errors
//	
//	private ApiError() {
//		timeStamp = LocalDateTime.now();//@the time of calling the method whatever the date time value are there it will provide i
//		
//	}
//	
//	public ApiError(HttpStatus status) {
...
//		addSubError(new ApiValidationError(object, field,rejectedValue,message));
//	}
//	private void addValidateError(String object, String message) {
//		addSubError(new ApiValidationError(object, message));
//	}
//	private void addValidationError(FieldError fieldError) {
//		this.addValidationError(fieldError.getObjectName(),fieldError.getField(),fieldError.getRejectedValue(),fieldError.getDefaultMessage());
...
//	}
//	
//	public void addValidation(ConstraintViolation<?> cv) {
